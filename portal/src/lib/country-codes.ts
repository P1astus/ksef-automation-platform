// Country codes accepted for JPK_V7M(3) KodKrajuNadaniaTIN: the MF country list
// (KodyKrajow_v13-0E.xsd, vendored in schemas/jpk-v7m3/) plus EL for Greece,
// which the JPK schema adds on top. Generated from there - don't hand-edit.
// The JPK type additionally rejects codes that can't be a TIN issuer (patterns
// [A-FH-Z][A-Z] and [A-Z][A-QS-Z]); jpk-generator.test.ts validates output
// against the real XSD.
...
const CODES = [
    ...
    'CZ', 'DE', 'DJ', 'DK', 'DM', 'DO', 'DZ', 'EC', 'EE', 'EG', 'EH', 'EL', 'ER', 'ES',
    ...
    'VC', 'VE', 'VG', 'VI', 'VN', 'VU', 'WF', 'WS', 'XC', 'XI', 'XK', 'XL', 'XU', 'YE',
    'YT', 'ZA', 'ZM', 'ZW',
] as const;
